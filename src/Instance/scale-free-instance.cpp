...
scale_free_instance::scale_free_instance(int nb_agents, int domain_size, double lambda, double p2, int max_nb_neighbors,
                                         int max_constr_arity, int nb_local_variables, int max_nb_boundary_variables,
                                         double p1_local_variables)  {

    instance::type = "scale-free";
    scale_free_graph graph(nb_agents, lambda, max_nb_neighbors);
...
std::string scale_free_instance::to_string() const {
