...
namespace dcop_generator
{
  ...
  private:
    ...
    void dump_decision_variables(std::ostream &os, std::vector<variable::ptr> variables, std::vector<domain::ptr> domains);
    void dump_random_variables(std::ostream &os, std::vector<variable::ptr> variables, std::vector<domain::ptr> domains);
    void dump_functions_pdc(std::ostream &os, std::vector<constraint_pdc::ptr> constraints);
    void dump_constraints_pdc(std::ostream &os, std::vector<constraint_pdc::ptr> constraints);
    ...
    void dump_initProb(std::ostream &os, std::vector<variable::ptr> variables);
    void dump_transition(std::ostream &os, std::vector<variable::ptr> variables);
    ...
    void dump_neighborCount(std::ostream &os);
